...
const columns: ColumnDef<z.infer<typeof RFIDTagSchema>>[] = [
  {
    id: "drag",
    header: () => null,
      ...
      <Label
        ...
        className={
          row.original.status === true
            ...
            : "w-20 h-4 bg-red-400 flex justify-center p-3 rounded-lg text-white"
        }
      >
...
export function TableRFIDTag({
  data: initialData,
  contentValue,
}: {
  data: z.infer<typeof RFIDTagSchema>[];
  contentValue: string;
}) {
